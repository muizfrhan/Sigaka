...
<head>
    ...
    <meta name="description" content="Sistem Informasi Penggajian Sistem Penggajian Karyawan">
    <meta name="keywords" content="Sistem Informasi Penggajian Sistem Penggajian Karyawan">
    <meta name="author" content="Jihad">
    <title><?= $title ?> - Sistem Penggajian Karyawan</title>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion d-print-none menu-shadow " data-scroll-to-active="true"
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
                        ...
                        <h3 class="brand-text">Sistem Penggajian Karyawan</h3>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Data
                            Master</span></a>
                    <ul class="menu-content">
                        <li class="<?php if ($this->uri->segment(1) == 'karyawan') echo 'active' ?>"><a
                                class="menu-item" href="<?= base_url('karyawan') ?>"><i class="ft-users"> </i> Data
                                Karyawan</a>
                        </li>
                        <li class="<?php if ($this->uri->segment(1) == 'jabatan') echo 'active' ?>"><a class="menu-item"
                                href="<?= base_url('jabatan') ?>"><i class="ft-award"></i> Data Jabatan</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="<?= base_url('laporan') ?>"><i class="ft-file"></i><span
                            class="menu-title" data-i18n="">Laporan</span></a>
                </li>
            </ul>
        </div>
    </div>
